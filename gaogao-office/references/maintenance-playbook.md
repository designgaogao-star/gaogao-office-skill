...
- whether older offices are missing v1.0.4 collaboration fields: `employee_report_transport`, `employee_report_fallback`, `employee_report_intake`, `role_calibration_policy`, `inter_agent_communication`, project-director thread ID status, file-first report paths, manual-copy fallback wording, and report-intake records
